...
namespace Examen.Dominio.Abstracto
{
    public interface IResponsableRepo
    {
        ...
        /// <returns>Task<List<Responsable>></returns>
        Task<List<Responsable>> ListarAsync(int pagina = 0, int cantItem = 50, string ordenar = "nombre", string orden = "ASC", string filtro = null);
        ...
        Task<Responsable> GetResponsableAsync(int id);
        ...
        Task<int> SalvarAsync(Responsable nueva, Responsable actual = null);
        ...
        Task<Responsable> RemoverAsync(Responsable item);

        /// <summary>
        /// Retorna el numero total de item
        /// </summary>
        /// <returns></returns>
        int TotalResponsables(string filtro = null);
    }
}
